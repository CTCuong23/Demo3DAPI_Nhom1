...
namespace Demo3DAPI.Migrations
{
    ...
    [Migration("20251117191030_ThemBangCategoryVaProduct")]
    partial class ThemBangCategoryVaProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Demo3DAPI.Models.PlayerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            FullName = "Admin",
                            Password = "$2a$11$b2mRXEVUMuRMXcxs8IweQO1c/8GYioY2QCRKiPZPHL5M0vU4jxGgi",
                            RoleID = 1,
                            UserName = "admin"
                        });
                });
